...
public class Filter {
    ...
    private boolean isEqual(String string1, String string2, String dataType) {
        if (dataType.equals("java.lang.Integer")) {
            return Integer.parseInt(string1) == Integer.parseInt(string2);
        } else if (dataType.equals("java.lang.Double")) {
            return Double.parseDouble(string1) == Double.parseDouble(string2);
        } else if (dataType.equals("java.util.Date")) {
            SimpleDateFormat formatter = new SimpleDateFormat(getDateFormat(string1));
            try {
                if (formatter.parse(string1).compareTo(formatter.parse(string2)) == 0)
                    return true;
                else
                    return false;
    ...
    private boolean isNotEqual(String string1, String string2, String dataType) {
        return !isEqual(string1, string2, dataType);
    }

    //method containing implementation of greaterThan operator
    private boolean isGreaterThan(String string1, String string2, String dataType) {
        if (dataType.equals("java.lang.Integer")) {
            return Integer.parseInt(string1) > Integer.parseInt(string2);
        } else if (dataType.equals("java.lang.Double")) {
            return Double.parseDouble(string1.toLowerCase()) > Double.parseDouble(string2.toLowerCase());
        } else if (dataType.equals("java.util.Date")) {
            SimpleDateFormat formatter = new SimpleDateFormat(getDateFormat(string1));
            try {
                if (formatter.parse(string1).compareTo(formatter.parse(string2)) > 0)
    ...
    private boolean isGreaterThanOrEqualTo(String string1, String string2, String dataType) {
        return isEqual(string1, string2, dataType) | isGreaterThan(string1, string2, dataType);
    }

    //method containing implementation of lessThan operator
    private boolean isLessThan(String string1, String string2, String dataType) {
        return !isGreaterThanOrEqualTo(string1, string2, dataType);
    }

    //method containing implementation of lessThanOrEqualTo operator
    private boolean isLessThanOrEqualTo(String string1, String string2, String dataType) {
        return isEqual(string1, string2, dataType) | isLessThan(string1, string2, dataType);
    }
}
